...
class OlFarve
{
    ...
    private static readonly double[] LAMBDA =
    {
    ...
    private const double DELTA_LAMBDA = 5.0;
    ...
    private static readonly double[] X_BAR =
    {
    ...
    private static readonly double[] Y_BAR =
    {
    ...
    private static readonly double[] Z_BAR =
    {
    ...
    public const double DEFAULT_PATH = 5.0;

    private static double Summate(double n, double[] cmf, double[] s)
    {
        double sum = 0.0;
    ...
    private static double CorrectGamma(double l) {
        if (l <= 0.0031308)
            l = l * 12.92;
        else
    ...
    public static double[] SRMToSRGB(double srm, double pathCM = DEFAULT_PATH)
    {
    ...
    public static double[] EBCToSRGB(double ebc, double pathCM = DEFAULT_PATH)
    {
    ...
    public static string RGBToHex(double[] rgb)
    {
        ...
        for (int i = 0; i < rgb.Length; ++i)
            text += Convert.ToInt32(Math.Round(rgb[i] * 255.0)).ToString("x2");
        return text;
    }
}
